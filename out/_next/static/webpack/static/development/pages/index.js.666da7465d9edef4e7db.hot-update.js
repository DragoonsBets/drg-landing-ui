...
})(["&&{display:flex;flex-direction:column;align-items:center;justify-content:center;padding:64px 0;scroll-snap-align:start;width:100%;position:relative;background-image:url('../static/roadmap-background.png');background-size:cover;min-height:100%;}&&:before{content:'';position:absolute;top:0;right:0;bottom:0;left:0;background-image:linear-gradient(to bottom right,#000000,#000000);opacity:0.6;}@media (min-width:1050px){&&{min-height:100vh}}&& > div{z-index:999;}"]);
...
//# sourceMappingURL=index.js.666da7465d9edef4e7db.hot-update.js.map